...
Data.drop(columns=["Unnamed: 0","ID", "","_id"], errors="ignore", inplace=True)
...
for i in range(tabla_distancias_1.shape[0]):
    datos_kmeans.loc[i,"dist_cluster_1"] = tabla_distancias_1.iloc[i, cluster[i]]
...
for i in range(tabla_distancias_2.shape[0]):
    datos_kmeans.loc[i,"dist_cluster_2"] = tabla_distancias_2.iloc[i, cluster_2[i]]
...
Cluster1_0 = Data.iloc[(tabla_distancias_1.sort_values(by =0).iloc[:100,0].index.tolist()),:].copy().describe()

Cluster1_1 = Data.iloc[(tabla_distancias_1.sort_values(by =1).iloc[:100,0].index.tolist()),:].copy().describe()

Cluster1_2 = Data.iloc[(tabla_distancias_1.sort_values(by =2).iloc[:100,0].index.tolist()),:].copy().describe()

Cluster1_3 = Data.iloc[(tabla_distancias_1.sort_values(by =3).iloc[:100,0].index.tolist()),:].copy().describe()

Cluster1_4 = Data.iloc[(tabla_distancias_1.sort_values(by =4).iloc[:100,0].index.tolist()),:].copy().describe()

Cluster1_5 = Data.iloc[(tabla_distancias_1.sort_values(by =5).iloc[:100,0].index.tolist()),:].copy().describe()


#CLÚSTERS DEL KMEANS 2

Cluster2_0 = Data2.iloc[(tabla_distancias_1.sort_values(by =0 ).iloc[:100,0].index.tolist()),:].copy().describe()

Cluster2_1 = Data2.iloc[(tabla_distancias_1.sort_values(by =1 ).iloc[:100,0].index.tolist()),:].copy().describe()

Cluster2_2 = Data2.iloc[(tabla_distancias_1.sort_values(by =2 ).iloc[:100,0].index.tolist()),:].copy().describe()

Cluster2_3 = Data2.iloc[(tabla_distancias_1.sort_values(by =3 ).iloc[:100,0].index.tolist()),:].copy().describe()
